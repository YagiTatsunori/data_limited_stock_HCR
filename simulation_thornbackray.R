...
results_thornbackray <- func(parameters = parameters,
                        ...
                        tau = 0.4,
                        theta = 0.75)
saveRDS(results_thornbackray,"results_thornbackray.RDS")
MSE_output <- results_thornbackray
# MSE_output <- readRDS("results_thornbackray.RDS")
...
source("C:/Users/00008252/OneDrive - 国立研究開発法人 水産研究・教育機構/デスクトップ/論文提出用/data_limited_HCR/Fig1.R")
source("C:/Users/00008252/OneDrive - 国立研究開発法人 水産研究・教育機構/デスクトップ/論文提出用/data_limited_HCR/Fig3.R")
